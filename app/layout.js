...
export async function generateMetadata() {
  ...
  return {
    title:
      c.data.title === "" || c.data.title === null
        ? "Welcome to " + c.data.domainName
        : c.data.title,
    description:
      c.data.description === "" || c.data.description === null
        ? "Join a vibrant community of developers, influencers, and entrepreneurs on " +
          c.data.domainName +
